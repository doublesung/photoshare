<template>
  <div class="modal center-modal fade rounded-4" id="addCollectionsModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="p-5">
          ...
          <form class="needs-validation" target="stop-reload">
            ...
            <div class="mb-4">
              ...
              <input type="text" class="form-control shadow-none" id="collectionTitleAdd" v-model="collectionTitleAdd" required>
            </div>
            <!-- 返回 -->
            <div class="gap-3 d-flex justify-content-end">
              <button class="btn btn-secondary text-white me-md-2" @click="addCollection" type="submit">
                建立收藏
              </button>
...
<script>
import {reqAddCollection} from '../../api/jsonServerAPI'
  ...
  methods: {
    ...
    async addCollection() {
      if(this.collectionTitleAdd) {
        ...
        await reqAddCollection(collection)

        // 獲取所有collection
        this.$store.dispatch('getCollections')
        
        this.addCollectionsModal.hide()
